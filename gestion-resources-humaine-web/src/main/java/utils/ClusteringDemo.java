...
//                System.out.println("data="+data);
            	...
            	System.out.println("dataset="+dataset[0][0][0]);//-1.08451280867585
            } 
            catch (Exception e) 
            {
...
//        		 try {
//        		        String path="C:\\Users\\X\\devstudio\\wildfly-9.0.1.Final2\\standalone\\deployments\\gestion-resources-humaine-ear.ear\\gestion-resources-humaine-web.war\\uploads\\dendrogramme.png";
//        		        File file=new File(path);
//        		        ((JPanel)canvas).save(file);
//        			} catch (IOException e) {
