...
public class AdminPagesFilter implements Filter{
    ...
    System.out.println("from admin pages filter url = " + ((HttpServletRequest) request).getRequestURL());
    ...
    if( (loginBean != null && loginBean.isLoggedln() && loginBean.getUser().getClass().getSimpleName().equals("Administrator")) || servletRequest.getRequestURL().toString().contains("login.jsf"))
    {
